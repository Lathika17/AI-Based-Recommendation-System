...
public class SimpleRecommendationSystem {
    ...
    public static void main(String[] args) {
        ...
        userPreferences.put("User1", Arrays.asList("Mobile", "Pendrive", "Machine"));
        userPreferences.put("User2", Arrays.asList("Mouse", "Keyboard", "Monitor"));
        userPreferences.put("User3", Arrays.asList("Laptop", "Light"));
        userPreferences.put("User4", Arrays.asList("Door", "Fan", "Webcam"));
